...
public class BlockStates extends BlockStateProvider {
    ...
    private void registerFirstBlock() {
        ResourceLocation txt = new ResourceLocation(GrowingStorm.MODID, "block/firstblock");
        BlockModelBuilder modelFirstblock = models().cube("firstblock", txt, txt, new ResourceLocation(GrowingStorm.MODID, "block/firstblock_front"), txt, txt, txt);
        BlockModelBuilder modelFirstblockPowered = models().cube("firstblock_powered", txt, txt, new ResourceLocation(GrowingStorm.MODID, "block/firstblock_powered"), txt, txt, txt);
